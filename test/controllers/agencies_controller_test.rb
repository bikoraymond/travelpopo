...
class AgenciesControllerTest < ActionController::TestCase
  ...
  test "should create agency" do
    assert_difference('Agency.count') do
      post :create, agency: { agency_name: @agency.agency_name, email: @agency.email, password: @agency.password }
    end
  ...
  test "should update agency" do
    patch :update, id: @agency, agency: { agency_name: @agency.agency_name, email: @agency.email, password: @agency.password }
    assert_redirected_to agency_path(assigns(:agency))
  end
